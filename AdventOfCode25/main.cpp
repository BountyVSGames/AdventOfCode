...
#include "Days/Header/DayTen.h"
#include "Days/Header/DayEleven.h"
#pragma endregion
...
int main()
{
    ...
    //AllAssignments.push_back(new DayTen(FileParser("Input\\DayTen.txt")));
    AllAssignments.push_back(new DayEleven(FileParser("Input\\DayEleven.txt")));
